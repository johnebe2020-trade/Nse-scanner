...
# =========================================================
# PAPER PORTFOLIO TRACKER — DEEP SUPPORT BOUNCE SCANNER
# Runs right after deep_support_bounce_scanner.py each day.
# Completely separate from paper_portfolio_tracker.py / paper_portfolio.csv
# (the short-term scanner's tracker) — different scan source, own file.
#
# Logic:
...
PORTFOLIO_FILE = "deep_paper_portfolio.csv"
...
def get_latest_scan_file():
    ...
    files = glob.glob("deep_support_bounce_*.csv")
...
print()
print("DEEP PAPER PORTFOLIO TRACKER")
print("=" * 55)
...
lines = [f"📈 <b>Deep Support Paper Portfolio Update — {today.strftime('%d %b %Y')}</b>"]
